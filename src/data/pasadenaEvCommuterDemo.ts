...
export const pasadenaDemoMeta = {
  ...
  methodologyVersion: 'SOV-to-EV compatibility v0.1',
  disclaimer:
...
export const pasadenaMetrics: PasadenaMetric[] = [
  { label: 'Commuters analyzed', value: '500', detail: 'Across City, employer, campus, and hospital demo cohorts', evidence: 'observed' },
...
export const pasadenaCorridors: PasadenaCorridor[] = [
  ...
  },
  {
    ...
    availableSeats: 19,
    highFitPreviews: 16,
    medianDetourMinutes: 4.1,
    medianRouteOverlap: 84,
    accessPointCompatible: 29,
    scheduleCompatible: 36,
    priority: 'High',
  },
  {
    id: 'highland-park-pasadena',
    name: 'Highland Park → Pasadena',
    gasolineSov: 27,
    plannedEvRoutes: 4,
    availableSeats: 7,
    highFitPreviews: 5,
    medianDetourMinutes: 5.8,
    medianRouteOverlap: 76,
    accessPointCompatible: 12,
    scheduleCompatible: 17,
    priority: 'Medium',
  },
  {
    id: 'alhambra-pasadena',
    name: 'Alhambra → Pasadena',
    gasolineSov: 23,
    plannedEvRoutes: 3,
    availableSeats: 5,
    highFitPreviews: 4,
    medianDetourMinutes: 4.9,
    medianRouteOverlap: 79,
    accessPointCompatible: 10,
    scheduleCompatible: 14,
    priority: 'Medium',
  },
];
...
export const eagleRockDecision = {
  ...
  accessPointCompatible: 24,
  recommendation:
    'Evaluate an institution-sponsored Eagle Rock → Pasadena clean-commute cohort using reviewed Access Points and planned BEV/PHEV routes.',
};
